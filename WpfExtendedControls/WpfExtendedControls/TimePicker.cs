...
namespace WpfExtendedControls
{
    ...
    [TemplatePart(Name = ElementSecondTextBox, Type = typeof(TextBox))]
    [TemplatePart(Name = ElementIncrementButton, Type = typeof(Button))]
    [TemplatePart(Name = ElementDecrementButton, Type = typeof(Button))]
